...
# sigmoid function standarize inpu, it make sure your value is between 0 and 1
def sigmoid(z):
    s = 1 / (1 + np.exp(-z))
    return s
...
# once we have w and b value,for any future prediction we can save values of w and b and
# can apply to any future data
